...
CREATE TABLE IF NOT EXISTS style_selections (id TEXT PRIMARY KEY, style_id TEXT NOT NULL, customer TEXT, meeting_date TEXT, proposed_price REAL, buying_group TEXT, modifications INTEGER NOT NULL DEFAULT 0, status TEXT NOT NULL DEFAULT 'complete', cost_snapshot REAL DEFAULT 0, created_by TEXT, updated_by TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL, FOREIGN KEY(style_id) REFERENCES styles(id) ON DELETE CASCADE);
